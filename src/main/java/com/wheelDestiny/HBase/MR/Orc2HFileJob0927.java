...
public class Orc2HFileJob0927 extends Configured implements Tool {
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new Orc2HFileJob0927(), args));
    }

    public int run(String[] args) throws Exception {
        Configuration conf = getConf();

        JobControl jobControl = new JobControl("Orc2HFileJob0927");

        Orc2Hfile0927 orc2Hfile = new Orc2Hfile0927();
        ...
        String[] inputParams = {jobOutputPath.toString(),"wheeldestiny:exam_hbase_split"};
